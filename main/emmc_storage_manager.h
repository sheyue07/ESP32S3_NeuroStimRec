...
#define EMMC_STORAGE_ERR_DMA_DESCRIPTOR ((esp_err_t)0x7114)
#define EMMC_STORAGE_ERR_DMA_OVERRUN    ((esp_err_t)0x7115)
#define EMMC_STORAGE_ERR_DMA_QUEUE_FULL ((esp_err_t)0x7116)
#define EMMC_STORAGE_ERR_DMA_UNEXPECTED_EOF ((esp_err_t)0x7117)
#define EMMC_STORAGE_ERR_DMA_BLOCK_STATE ((esp_err_t)0x7118)
#define EMMC_STORAGE_ERR_CONTINUOUS_RX_UNKNOWN ((esp_err_t)0x7119)
